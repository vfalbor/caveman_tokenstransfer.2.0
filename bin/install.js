...
const OPENCODE_SKILL_DIRS  = ['caveman', 'caveman-commit', 'caveman-review', 'caveman-help', 'caveman-stats', 'caveman-compress', 'caveman-transfer', 'caveman-fullstack', 'tokenstransfer', 'tokenstranslation', 'cavecrew'];
const OPENCODE_AGENT_FILES = ['cavecrew-investigator.md', 'cavecrew-builder.md', 'cavecrew-reviewer.md'];
const OPENCODE_COMMAND_FILES = ['caveman.md', 'caveman-commit.md', 'caveman-review.md', 'caveman-compress.md', 'caveman-stats.md', 'caveman-transfer.md', 'caveman-fullstack.md', 'tokenstransfer.md', 'tokenstranslation.md', 'caveman-help.md'];
